...
import select
import sys
from lesson_5.config import ACTION, PRESENCE, TIME, RESPONSE, OK, WRONG_REQUEST, \
...
from lesson_5.logs import server_config_log
from lesson_5.descriptors import SockVerify
from lesson_5.meta import ServerVerifier
